...
export default function TechfestSports() {
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        const sportsEvents = data.filter(event => 
          event.category.toLowerCase().includes('sport') || 
          event.category.toLowerCase().includes('athletic') ||
          event.category.toLowerCase().includes('physical') ||
          event.category.toLowerCase().includes('fitness') ||
          event.category.toLowerCase().includes('game')
        );
        ...
        // Sample sports events as fallback
      ...
      <div className="relative min-h-screen overflow-hidden bg-black text-white">
        ...
        <div className="flex h-screen items-center justify-center text-white/60">
          <div className="text-center">
            <div className="text-2xl font-bold mb-4">Loading Sports Events...</div>
    ...
    <div className="relative min-h-screen overflow-hidden bg-black text-white">
      ...
      <div className="fixed top-6 right-6 z-50 text-right">
        <motion.div
          ...
          className="text-sm font-bold uppercase tracking-widest text-green-400 mb-1"
        >
          Sports Events
        </motion.div>
        <motion.div
      ...
      <div className="h-screen snap-y snap-mandatory overflow-y-scroll">
          ...
          >
            ...
            <div className="z-20 flex w-full max-w-2xl flex-col space-y-6">
              <motion.div 
                ...
                className="text-sm font-bold uppercase tracking-widest text-green-400"
              >
                Sports Event #{event.number || idx + 1}
              </motion.div>
              ...
              >
                <button
                  ...
                  className="rounded-2xl bg-gradient-to-r from-green-500 to-teal-500 px-8 py-4 font-semibold text-white shadow-lg hover:from-green-600 hover:to-teal-600 transition-all duration-300 transform hover:scale-105"
        ...
        {events.length === 0 && (
          <div className="flex h-screen items-center justify-center text-white/60">
            <div className="text-center">
              <div className="text-3xl font-bold mb-4">No Sports Events</div>
              <div>Check back later for exciting athletic competitions!</div>
            </div>
          </div>
        )}
      </div>
      ...
      <AnimatePresence>
        {learnMoreEvent && (
          <Modal onClose={() => setLearnMoreEvent(null)}>
            <div className="max-h-[80vh] w-full max-w-2xl overflow-y-auto rounded-2xl bg-gray-900/95 p-8 text-white backdrop-blur border border-gray-700">
              <h2 className="mb-4 text-3xl font-bold text-green-400">{learnMoreEvent.name}</h2>
              ...
              <div className="mb-6">
                <h3 className="mb-2 text-xl font-semibold text-green-300">Description</h3>
                <p className="text-white/80">{learnMoreEvent.description}</p>
              </div>

              {learnMoreEvent.rules?.length ? (
                <div className="mb-6">
                  <h3 className="mb-2 text-xl font-semibold text-green-300">Rules & Guidelines</h3>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6 text-sm">
                <div className="bg-gray-800/50 p-3 rounded-lg">
                  <strong className="text-green-300">Category:</strong> {learnMoreEvent.category}
                </div>
                <div className="bg-gray-800/50 p-3 rounded-lg">
                  <strong className="text-green-300">Team size:</strong> {learnMoreEvent.teamMin}–{learnMoreEvent.teamMax}
                </div>
              </div>
        ...
        {registerEvent && (
          <Modal onClose={() => setRegisterEvent(null)}>
            ...
            >
              <h2 className="mb-4 text-2xl font-bold text-green-400">{`Register: ${registerEvent.name}`}</h2>
              ...
              <input
                ...
                className="mb-4 w-full rounded-lg bg-gray-800/50 border border-gray-600 px-3 py-2 text-white placeholder-white/50 focus:border-green-400 focus:outline-none"
                required
              ...
              <div className="mb-6">
                <div className="mb-3 flex items-center justify-between">
                  <span className="font-semibold text-green-300">Team Members</span>
                  <div className="flex gap-2">
                    <button
                      ...
                      className="rounded-md bg-green-600 hover:bg-green-700 px-2 py-1 text-xs text-white transition-colors"
                ...
                {members.map((mem, idx) => (
                  <div key={idx} className="mb-3 flex gap-2">
                    <input
                      ...
                      className="flex-1 rounded-lg bg-gray-800/50 border border-gray-600 px-3 py-2 text-white placeholder-white/50 focus:border-green-400 focus:outline-none"
                    ...
                    <input
                      ...
                      className="w-48 rounded-lg bg-gray-800/50 border border-gray-600 px-3 py-2 text-white placeholder-white/50 focus:border-green-400 focus:outline-none"
              ...
              <div className="flex gap-4">
                ...
                <button
                  type="submit"
                  className="flex-1 rounded-lg bg-gradient-to-r from-green-500 to-teal-500 hover:from-green-600 hover:to-teal-600 px-4 py-3 font-semibold text-white transition-all duration-300"
